...
export function setSelection(ids: readonly string[], opts?: { anchor?: string | null }): void {
...
export function pruneSelection(existing: ReadonlySet<string>): void {
  if (selected.every((id) => existing.has(id)) && (anchorId === null || existing.has(anchorId))) return;
