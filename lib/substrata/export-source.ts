...
export type ExportRenderer = (opts: ExportRenderOptions) => HTMLCanvasElement | null;
...
export function renderForExport(opts: ExportRenderOptions): HTMLCanvasElement | null {
