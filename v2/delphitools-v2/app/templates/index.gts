...
<template>
  <div class="dt-page">
    <header class="dt-hero">
      <img src="/delphi-friday.png" alt="" class="dt-hero-art" />
      ...
      <div class="dt-hero-copy">
        ...
        <p>
          No logins, no registration, no data collection. I can&apos;t believe I
          have to say that. Long live the handmade web.
        </p>
      </div>
    </header>
    ...
    <section class="dt-section">
      <h2 class="dt-section-title">
        Greatest Hits
        <span class="dt-section-count">{{featuredTools.length}}</span>
      </h2>
    ...
    {{#each toolCategories as |category|}}
      <section class="dt-section">
        <h2 class="dt-section-title">
          {{category.name}}
          <span class="dt-section-count">{{category.tools.length}}</span>
        </h2>
