...
surfaced as a regular `lib/tools.ts` grid entry (Images & Assets + Greatest
...
| Image Stitcher (`image-stitcher`)             |  ✅  |      ❌      |  ❌  | new 2026-07; edge-stitch + batch grid                                |
...
| Barcode Generator (`code-genny`)             |  ✅  | ✅ `barcode` |  ✅  | Transparent PNG export + toggleable human-readable numbers (HRI) under 1D codes: W ✅ · C ❌ · I ❌                                                                                                                                                                                |
